 ...
 *   4. Cloudflare Turnstile siteverify (skipped in dev when no secret is set)
...
export async function POST(req: NextRequest) {
  ...
  if (TURNSTILE_SECRET) {
    ...
    try {
      ...
      console.error("[contact] Turnstile siteverify network error:", e);
      return NextResponse.json(
