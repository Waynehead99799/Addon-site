    ...
    <section className="relative py-20 md:py-28 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-12 gap-6 md:gap-10">
        ...
        <div className="col-span-12 md:col-span-9">
          <Reveal y={24}>
            <p className="text-[22px] md:text-[30px] lg:text-[36px] leading-[1.25] tracking-[-0.01em] text-white/90">
          ...
          <Reveal delay={120} y={20}>
            <p className="mt-8 text-[16px] md:text-[17px] text-white/60 leading-[1.7] max-w-[46rem]">
