    ...
    <section className="relative overflow-hidden min-h-[100svh] flex flex-col">
      ...
      <div className="relative z-20 flex-1 flex items-center justify-center pt-28 md:pt-32 pb-8">
        ...
        <Reveal delay={80} y={24}>
          <h1 className="mt-8 md:mt-10 font-semibold tracking-[-0.02em] leading-[0.9] text-[56px] sm:text-[76px] md:text-[96px] lg:text-[112px]">
        ...
        <Reveal delay={180} y={18}>
          <p className="mt-6 md:mt-8 text-[16px] md:text-[18px] text-white/70 max-w-[36rem] leading-[1.55] mx-auto">
        ...
        <Reveal delay={260} y={16} className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="#work" className="group inline-flex items-center gap-2 text-white/70 hover:text-white text-[14px] px-4 py-2.5">
