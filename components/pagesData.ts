...
export const CASE_STUDIES_DATA: CaseStudyDetail[] = [
  ...
  },
  {
    ...
    gallery: {
      hero: "/case-studies/pe-assessment-platform/image.png",
      ...
      webCaptions: [
        "Teacher home — national fitness protocols (PACER, curl-ups, sit-and-reach, one-mile run) ready to assign, score, and schedule.",
        "Live class assessment — One Mile Run timing for Period 1, capturing per-student finish times in real time.",
      ],
    },
  },
  {
    slug: "campusmate",
    title: "CampusMate — Academic Marketplace",
    client: "Confidential",
    industry: "Education · Marketplace",
    categories: ["Education", "Marketplace"],
    profile: "/case-studies/campusmate/profile.png",
    subtitle: "A university-grade academic marketplace — peer tutoring, lecture notes, study groups, and an institutional admin portal, all stitched together with wallet-based payments and verified ratings.",
    overview: "CampusMate turns the messiest part of student life — finding the right tutor, sharing course notes, joining the right study group, getting paid for being good at a subject — into a single, governed marketplace that universities can sanction. Students earn and spend through an in-app wallet; tutors build a reputation tied to their academic record; and university admins get an institutional portal to monitor activity, integrations, and compliance across multiple campuses.",
    challenge: "Peer learning at scale is fragmented across Discord servers, group chats, photocopied notes, and ad-hoc Venmo payments. Universities can't see it, can't govern it, and can't capture the value. Students who could earn from tutoring couldn't prove credibility; those who needed help couldn't filter signal from noise. The institution that wanted to help had no way to.",
    solution: "We built a verified academic marketplace where tutors are tied to real course enrolments, notes are course-tagged, and study groups live alongside chat threads. A built-in wallet handles micropayments, withdrawals, and tutor earnings. An institutional admin portal gives universities a real-time view of their marketplace — usage by department, top tutors, integration health, and audit trails — without compromising student privacy.",
    keyFeatures: [
      { icon: "People", title: "Verified peer tutors", desc: "Tutor profiles tied to real course enrolments and graded performance — credibility built into the badge." },
      { icon: "File", title: "Course-tagged notes", desc: "Notes uploaded against the exact course code, searchable across the institution and rated by students who used them." },
      { icon: "Network", title: "Study groups + chat", desc: "Class-anchored chat rooms with file sharing, live code snippets, and pinned reference threads." },
      { icon: "Clock", title: "Tutoring sessions", desc: "Schedule, reschedule, and pay for sessions in one flow — calendars sync with the student's class timetable." },
      { icon: "Wallet", title: "In-app wallet", desc: "Earn, withdraw, and spend without leaving the app. Stripe-backed compliance, escrow on session completion." },
      { icon: "Building", title: "Institutional admin portal", desc: "Universities get a real-time dashboard of marketplace health — top courses, top tutors, integration status, audit logs." },
      { icon: "Shield", title: "Privacy-first integrations", desc: "Plugs into the institution's SSO and student information system without leaking PII into the marketplace surface." },
      { icon: "Chart", title: "Reputation analytics", desc: "Tutor scorecards combine session completion rate, repeat-bookings, and student-rated impact on grades." },
    ],
    results: [
      { value: "Verified", label: "Peer tutor reputation" },
      { value: "Wallet-native", label: "Earnings, withdrawals, escrow" },
      { value: "Institution-grade", label: "SSO + audit-trail ready" },
      { value: "Multi-campus", label: "Single admin portal" },
    ],
    techStack: ["React", "Node.js", "PostgreSQL", "Stripe Connect", "AWS", "Redis", "WebSocket", "SSO/SAML"],
    gallery: {
      hero: "/case-studies/campusmate/hero.png",
      heroCaption: "CampusMate — Academic Nexus. The verified marketplace for peer tutoring and course notes.",
      web: [
        "/case-studies/campusmate/web-1.png",
        "/case-studies/campusmate/web-2.png",
      ],
      webCaptions: [
        "Student dashboard — courses taken, notes shared, tutor ranking, and active enrolments.",
        "Institutional admin portal — marketplace health, university management, and integration status.",
      ],
      mobile: [
        "/case-studies/campusmate/mobile-1.png",
        "/case-studies/campusmate/mobile-2.png",
        "/case-studies/campusmate/mobile-3.png",
      ],
      mobileCaptions: [
        "Class-anchored chat — questions, snippets, and reference threads in one place.",
        "Course discovery and tutor search.",
        "Tutor profile, ratings, and session booking.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    profile: "/case-studies/connected-motorcycle-app/profile.png",
    ...
    gallery: {
      hero: "/case-studies/connected-motorcycle-app/hero.png",
      heroCaption: "Connected motorcycle companion app — pair, ride, protect, connect.",
      web: [
        "/case-studies/connected-motorcycle-app/web-1.png",
        "/case-studies/connected-motorcycle-app/web-2.png",
      ],
      webCaptions: [
      ...
      mobile: [
        "/case-studies/connected-motorcycle-app/mobile-1.png",
        "/case-studies/connected-motorcycle-app/mobile-2.png",
        "/case-studies/connected-motorcycle-app/mobile-3.png",
      ],
      mobileCaptions: [
  ...
  },
  {
    ...
    categories: ["Marketplace", "IoT & Hardware"],
    profile: "/case-studies/multi-region-brand-platform/profile.png",
    ...
    gallery: {
      hero: "/case-studies/multi-region-brand-platform/hero.png",
      heroCaption: "Multi-region brand and product platform — one engine, many markets.",
      web: [
        "/case-studies/multi-region-brand-platform/web-1.png",
        "/case-studies/multi-region-brand-platform/web-2.png",
      ],
      webCaptions: [
      ...
      mobile: [
        "/case-studies/multi-region-brand-platform/mobile-1.png",
        "/case-studies/multi-region-brand-platform/mobile-2.png",
        "/case-studies/multi-region-brand-platform/mobile-3.png",
      ],
      mobileCaptions: [
  ...
  },
  {
    ...
    categories: ["Marketplace"],
    profile: "/case-studies/global-motorcycle-platform/profile.png",
    ...
    gallery: {
      hero: "/case-studies/global-motorcycle-platform/hero.png",
      heroCaption: "Global motorcycle brand platform — immersive product pages, store locator, distribution.",
      web: [
        "/case-studies/global-motorcycle-platform/web-1.png",
        "/case-studies/global-motorcycle-platform/web-2.png",
      ],
      webCaptions: [
      ...
      mobile: [
        "/case-studies/global-motorcycle-platform/mobile-1.png",
        "/case-studies/global-motorcycle-platform/mobile-2.png",
        "/case-studies/global-motorcycle-platform/mobile-3.png",
      ],
      mobileCaptions: [
