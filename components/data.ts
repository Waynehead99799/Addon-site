...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    kpi: "Tutors · notes · study groups",
    desc: "A university-grade academic marketplace — peer tutoring, lecture notes, study groups, and an institutional admin portal. Wallet-based payments and ratings keep the campus economy moving.",
    image: "/case-studies/campusmate/image.png",
    icon: "School",
    palette: ["#6366f1", "#a78bfa", "#0E0B0A"],
    board: "grid",
  },
  {
    id: "tx-cleaning",
  ...
  },
  {
    ...
    image: "/case-studies/fleet-telematics/image.png",
    icon: "Truck",
