...
export default function AboutTeaser() {
  return (
    <section id="about" className="section-reveal relative py-14 md:py-20 lg:py-28 border-t border-white/5">
          ...
          <Reveal delay={200} y={18}>
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
              <div>
                ...
                <div className="text-[30px] sm:text-[40px] md:text-[52px] lg:text-[60px] font-semibold tracking-[-0.03em] leading-none num-grad">2011</div>
              </div>
              <div>
                <div className="text-[11px] uppercase tracking-[0.22em] text-white/55 font-mono mb-3">Team</div>
                <div className="text-[30px] sm:text-[40px] md:text-[52px] lg:text-[60px] font-semibold tracking-[-0.03em] leading-none num-grad">35+</div>
              ...
              <div>
                ...
                <div className="text-[30px] sm:text-[40px] md:text-[52px] lg:text-[60px] font-semibold tracking-[-0.03em] leading-none num-grad">ISO</div>
